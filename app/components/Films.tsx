...
>
  ...
  <div className="group relative h-[300px] w-[200px] overflow-hidden rounded-xl">
...
<div className="absolute inset-0 overflow-hidden">
  <div className="absolute -left-24 top-0 h-full w-16 rotate-12 bg-white/20 blur-xl transition-all duration-700 group-hover:left-72" />
</div>

<div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
